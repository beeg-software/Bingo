...
namespace Blank7.BackEnd.Persistance.Entities
{
    ...
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            // Split the assemblyDirectory by the "Blank7.BackEnd.Persistance" substring
            string[] pathParts = assemblyLocation.Split(new[] { @"\Blank7.BackEnd.Persistance" }, StringSplitOptions.None);
            string persistanceProjectPath = pathParts[0] + @"\Blank7.BackEnd.Persistance\";
            string serverProjectPath = pathParts[0] + @"\Blank7.BackEnd.Server\";
